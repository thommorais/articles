...
<a class="btn-fechar" href="javascript:void(0);" onClick="fecharExportar()"><i class="fa fa-times" aria-hidden="true"></i></a>
                ...
                <div class="edicoes">                        
                    ...
                    <p class="edicao simples" title="<fmt:message key='site.cliquevisualizar'/>"> 
                        <a class="btn" href="javascript:void(0);"  onClick="marcarParaExportar(this,<%= bean.getId()%>);"> 
                            ...
                            <i class="fa fa-check" aria-hidden="true"></i><img class="primeira" src="<%= base%><%= bean.getThumb()%>"  title="<fmt:message key='site.cliqueler'/>"/>
                            <% if (!apenasFotos) {%>
                            <br/>
                    ...
                    <p class="edicao duplo" title="<fmt:message key='site.cliquevisualizar'/>"> 
                        ...
                        <span class="duplo"> 
                            ...
                            <a class="btn" href="javascript:void(0);"   onClick="marcarParaExportar(this,<%= bean2.getId()%>);">
                                <input type="checkbox" name="exportpage" id="exportpage-<%= bean2.getId()%>" value="<%=  bean2.getId()%>"/>
                                <i class="fa fa-check" aria-hidden="true"></i><img class="segunda" src="<%= base%><%= bean2.getThumb()%>"  title="<fmt:message key='site.cliqueler'/>"/>                            
                            </a>
                        </span> 
                        <% if (!apenasFotos) {%>
                        <br/>   
