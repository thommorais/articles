...
var boxes_ = document.querySelectorAll('.drag'),
    dragSrcEl_ = null,
    target = null,
    folders = {};
...
handleDragEnd = function handleDragEnd(e) {
    ...
    if (folders.target && target.dataset.folder != 'false') {
        ...
        var folderTarget = document.querySelector('[data-name="' + folders.folder + '"]');
...
var newFolder = document.querySelector('.new');
...
var Menu = function () {
    function Menu(btn) {
        ...
        this.btn.addEventListener('click', function () {
            return _this2.openOverlay(_this2.btn);
        });
    }
...
var btns = document.querySelectorAll('.new-menu');
