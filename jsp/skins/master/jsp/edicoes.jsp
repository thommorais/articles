...
<a class="btn-fechar" href="javascript:void(0);" onClick="fecharTodasEdicoes()"><i class="icon-remove"></i></a>

<p class="titulo">TODAS AS EDIÇÕES</p>
<div id="scrollbar1" class="tiny-scrollbar-v">
    <div class="scrollbar">
        <div class="track">
            <div class="thumb">
                <div class="end"></div>
                ...
                <p class="edicao">             
                    <a class="btn" href="#">
                        ...
                        <a href="javascript:alert('Você não tem acesso a essa edição');"><img src="<%= base + bean.getPath()%>" border="1"  title="<fmt:message key="site.cliqueler"/>" class="imgdisabled"/></a>
                            <%} else {%>
                        <a href="<%= base + link%>?numero=<%= bean.getNr()%><%=tx != null && tx != "" ? "&keywords=" + tx : ""%>"><img src="<%= base + bean.getPath()%>"  border="1" title="<fmt:message key="site.cliqueler"/>"/></a>
                            <% }%>
                        <br/>
                        <span>   
