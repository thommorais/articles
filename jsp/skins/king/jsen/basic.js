...
function ajaxRegisterZoom() {
    ...
    if (pageAnchor != null) {
        if (dataLayer != null) {
            dataLayer.push({'event': 'eventTracking', 'eventCategory': 'Cliques Flip - ' + sigla, 'eventAction': 'Aplicou zoom', 'eventLabel': dataAnalytics});
        } else {
            if (_gaq) {
...
function getPrintLink() {
    jQuery.getScript(base + 'flip/jornal/skins/king/jsen/printPDF.js');
    flag = 0;
    var pageAnchor = MegaZine.getCurrentAnchor();
    var pageEdition = getCurrentEdition();
...
function exportaMarcadas() {
    ...
    jQuery.fn.modalBox({
        ...
        directCall: {
            data: '<p>Wait while file is being created ... </p>'
        }
    });
    window.location.href = url;
...
function pesquisa() {
    ...
    if (object.value.length < 4) {
        ...
        jQuery("#aguarde").html("Please wait...");
        jQuery("#aguarde").show();
...
function recomendaAmigo() {
    ...
    if (jQuery("#para1").val() == "" && jQuery("#para2").val() == "" && jQuery("#para3").val() == "" && jQuery("#para4").val() == "") {
        alert("You need to set at least one friend mail");
        return false;
    }
    if (jQuery("#para1").val() != "" && !jQuery.validateEmail(jQuery("#para1").val())) {
        alert("The mail " + jQuery("#para1").val() + " seems incorrect. Fix it.");
        return false;
    }
...
function entraEmContato() {
    ...
    if (jQuery("#emailId").val() == "") {
        ...
        if (!jQuery.validateEmail(jQuery("#emailId").val())) {
            alert("Inform a valid mail");
            return false;
        }
    }
    if (jQuery("#assunto").val() == "") {
        alert("Inform the subject.");
        return false;
    }
    if (jQuery("#mensagem").val() == "") {
        alert("Inform the message.");
        return false;
    }
...
function comentaPagina() {
    ...
    if (jQuery("#emailId").val() == "") {
        ...
        if (!jQuery.validateEmail(jQuery("#emailId").val())) {
            alert("Your email seems wrong. Please, fix it!");
            return false;
        }
    }
    if (jQuery("#mensagem").val() == "") {
...
function openCommentMode() {
    ...
    if (dataLayer != null) {
        dataLayer.push({'event': 'eventTracking', 'eventCategory': 'Cliques Flip - ' + sigla, 'eventAction': 'Abriu comentarios', 'eventLabel': dataAnalytics});
    }
...
function openContactMode() {
    ...
    if (dataLayer != null) {
        dataLayer.push({'event': 'eventTracking', 'eventCategory': 'Cliques Flip - ' + sigla, 'eventAction': 'Abriu Contato', 'eventLabel': dataAnalytics});
    }
...
function adjustHeight() {
    var height = jQuery(window).height() - pageHeightSpace;
...
jQuery(function ($) {
    ...
    jQuery('#basic-modal .imprimir').click(function (e) {
        ...
        if (dataLayer != null) {
            dataLayer.push({'event': 'eventTracking', 'eventCategory': 'Cliques Flip - ' + sigla, 'eventAction': 'Abriu Imprimir', 'eventLabel': dataAnalytics});
        }
    ...
    jQuery('#basic-modal .texto').click(function (e) {
        ...
        if (dataLayer != null) {
            dataLayer.push({'event': 'eventTracking', 'eventCategory': 'Cliques Flip - ' + sigla, 'eventAction': 'Abriu Texto', 'eventLabel': dataAnalytics});
        }
    ...
    jQuery('#basic-modal .pdf').click(function (e) {
        ...
        if (dataLayer != null) {
            dataLayer.push({'event': 'eventTracking', 'eventCategory': 'Cliques Flip - ' + sigla, 'eventAction': 'Abriu PDF', 'eventLabel': dataAnalytics});
        }
        ...
        jQuery('#basic-modal .procurar').click(function (e) {
            ...
            if (dataLayer != null) {
                dataLayer.push({'event': 'eventTracking', 'eventCategory': 'Cliques Flip - ' + sigla, 'eventAction': 'Abriu Pesquisa', 'eventLabel': dataAnalytics});
            }
    ...
    jQuery('#basic-modal .recomendar').click(function (e) {
        if (dataLayer != null) {
            dataLayer.push({'event': 'eventTracking', 'eventCategory': 'Cliques Flip - ' + sigla, 'eventAction': 'Abriu recomendar', 'eventLabel': dataAnalytics});
        }        
        jQuery.fn.modalBox({
            setWidthOfModalLayer: 600,
            directCall: {
    ...
    jQuery('.multimidia_fr').click(function () {
        MegaZine.firstPage();
        if (dataLayer != null) {
            dataLayer.push({'event': 'eventTracking', 'eventCategory': 'Cliques Flip - ' + sigla, 'eventAction': 'Primeira Pagina', 'eventLabel': dataAnalytics});
        }
    });
    ...
    jQuery('.multimidia_prev').click(function () {
        MegaZine.prevPage();
        if (dataLayer != null) {
            dataLayer.push({'event': 'eventTracking', 'eventCategory': 'Cliques Flip - ' + sigla, 'eventAction': 'Retornou Pagina', 'eventLabel': dataAnalytics});
        }
    });
    ...
    jQuery('.multimidia_next').click(function () {
        MegaZine.nextPage();
        if (dataLayer != null) {
            dataLayer.push({'event': 'eventTracking', 'eventCategory': 'Cliques Flip - ' + sigla, 'eventAction': 'Avancou Pagina', 'eventLabel': dataAnalytics});
        }
    });
    ...
    jQuery('.multimidia_ff').click(function () {
        MegaZine.lastPage();
        if (dataLayer != null) {
            dataLayer.push({'event': 'eventTracking', 'eventCategory': 'Cliques Flip - ' + sigla, 'eventAction': 'Ultima Pagina', 'eventLabel': dataAnalytics});
        }
    });
    ...
    if (isIE) {
        ...
        if (ver > -1 && ver <= 6.0) {
            alert('Recomendamos que atualize seu navegador para uma versão mais recente ou utilize o Firefox');
        }
    }
...
function openEditionMode(p) {
    ...
    var html = '<div id="header"><li class="header">ARCHIVE</li></div>';
    var pageAnchor = getCurrentEdition();
    page = p;
    ...
    var edicaoId = jQuery("#edicaoId").val();    
    ...
    jQuery.post(url, function (data) {
        ...
        if (dataLayer != null) {
            dataLayer.push({'event': 'eventTracking', 'eventCategory': 'Cliques Flip - ' + sigla, 'eventAction': 'Abriu edicoes', 'eventLabel': dataAnalytics});
        }
...
function openProdutosMode(p) {
    var html = '<div id="header"><li class="header">Products ands Chapters</li></div>';
    var pageAnchor = getCurrentEdition();
    page = p;
    if (!page || page == undefined) {
        page = 0;
...
function openVolumesMode(p) {
    var html = '<div id="header"><li class="header">Volumns</li></div>';
    var pageAnchor = getCurrentEdition();
    page = p;
    if (!page || page == undefined) {
        page = 0;
...
function playSound(id) {
    ...
    if (dataLayer != null) {
        dataLayer.push({'event': 'eventTracking', 'eventCategory': 'Cliques Flip - ' + sigla, 'eventAction': 'Abriu Audio', 'eventLabel': dataAnalytics});
    }
...
function validateRecommend(current, total) {
    if (jQuery("#facerecomenda")) {
        ...
        if (facebookshare == true) {
            faceurltemplate = "http://www.facebook.com/plugins/like.php?href=$URL&;layout=standard&show_faces=false&width=380&action=like&colorscheme=light&height=30&locale=en_US&share=true";
        } else {
            faceurltemplate = "http://www.facebook.com/plugins/like.php?href=$URL&;layout=standard&show_faces=false&width=380&action=recommend&colorscheme=light&height=30&locale=en_US";
        }
...
function shopping(code) {
    if (window.confirm("Confirma o pedido do produto código " + code)) {
        products.push(code);
    }
}
