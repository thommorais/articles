    ...
    <tr>
        ...
        <td id="buttons_layer">
            ...
            <a href="javascript:openRecomendMode();">
                <img src="<%= base%><c:out value='${page.flipModeloPublicacaoidid_modelo.prefs.iconeRecomendarSite}'/>" alt="Recomendar página para um colega" title="Recomendar página para um colega" width="<%= width%>" />
            </a>
            ...
            <c:if test="${!empty logado}">
             <a href="javascript:openCommentModeMarkup();"   title="Clique aqui para criar um comentário nessa página" >
                    <img src="<%= base%>flip/jornal/images/postit.png"  alt="Clique aqui para criar um comentário nessa página" width="<%= width%>"/>
                </a>
            </c:if>
        </td>
    </tr>
