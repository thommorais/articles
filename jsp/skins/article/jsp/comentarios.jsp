...
<div class="padding"> 
    <a class="btn-fechar" href="javascript:void(0);" onClick="fecharComentar()"><i class="fa fa-times" aria-hidden="true"></i></a>
    <p class="titulo">COMENTÁRIOS</p>

    <c:choose>
        <c:when test="${!empty comments}">
            <span> <a href="javascript:openCommentMode();"><fmt:message key='site.article.comment.title'/></a> </span>
            <br/>
