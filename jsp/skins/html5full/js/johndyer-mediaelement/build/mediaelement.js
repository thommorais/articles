...
mejs.YouTubeApi = {
	...
	createIframe: function(settings) {
		...
		player = new YT.Player(settings.containerId, {
			...
			playerVars: {controls:1,wmode:'transparent'},
			events: {
				'onReady': function() {
	...
	createFlash: function(settings) {
		...
		*/
		...
		var specialIEContainer,
			youtubeUrl = '//www.youtube.com/apiplayer?enablejsapi=1&amp;playerapiid=' + settings.pluginId  + '&amp;version=3&amp;autoplay=0&amp;controls=1&amp;modestbranding=1&loop=0';
