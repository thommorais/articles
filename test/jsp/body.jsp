		...
		<div class="padding"> <a class="btn-fechar" href="javascript:void(0);" onClick="fecharShare()"><i aria-hidden="true" class="fa fa-times"></i></a>
			...
			<c:if test="${page.flipModeloPublicacaoidid_modelo.prefs.exportar || page.flipModeloPublicacaoidid_modelo.prefs.modoTexto}">
				...
				<c:if test="${page.flipModeloPublicacaoidid_modelo.prefs.modoTexto}">
					<a class="btn-exportar texto" href="javascript:void(0);" onclick="abrirTexto();" >
					  <img src="<%= base%>flip/jornal/skins/master/img/exportar-texto.png" width="32" height="32"> Texto</a>
				</c:if>
			</c:if>
			<div class="clear"></div>
		</div>
			...
			<div class="menu">
				...
				<div class="icones-direita">
					<ul>
						...
						<!--
						<li>
							<a id="mdl-help"  title="Help" id="mdl-multimidia" href="javascript:void(0);" class="menu-item new-menu">
...
<div id="fullscreenid">
	<section id="content">
		...
		<article id="interna">
			...
			<div id="reader" class="magazine-viewport stage">
				...
				<!-- area de setas -->
				<div id="readerarrows">
					<div class="arrow-navigate arrow-navigate-left previous-button" title="Página anterior">
		...
		<script type="text/javascript">
		    var news_json = 'http://flip.abanca.com.br/flip/jornal/skins/article/noticias.json'
		    var article_json = 'http://flip.abanca.com.br/flip/jornal/skins/article/materia.json'
		...
		<div id="article-reader" style="opacity: 0">
			<div id="wrapper">
				<div class="wide">
	...
	<aside id="zoom-slider">
		<div class="flex">
			<div class="output">zoom: <output>100</output>%</div>
			<div class="message">Tecla <span>ESC</span> para sair do zoom</div>
		</div>
		<input value="1" type="range" min="0" max="10" data-rangeSlider>
	</aside>

	<aside id="switch-mode">
		<button onclick="switchToVertical();" id="switchToVertical" type="button">
	...
	<footer id="footer">
		...
		<nav>
		  <ul class="paginacao bg-geral">
			  ...
			  <li class="prev-pag pagination"><a class="btn multimidia_prev" href="#"><i class="fa fa-chevron-left" aria-hidden="true"></i></a></li>
			  <li>
				  <input type="text" name="" id="" value="1" maxlength="5" class="multimidia_textfield" />
			  </li>
			  <li class="next-pag pagination"><a class="btn multimidia_next" href="#"><i class="fa fa-chevron-right" aria-hidden="true"></i></a></li>
	...
	<section data-overlay="mdl-help" class="help overlay-content ">
