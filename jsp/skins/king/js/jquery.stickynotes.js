(function(jQuery) {
    ...
    jQuery.fn.stickyNotes.prepareContainer = function(container) {
        ...
        if (jQuery.fn.stickyNotes.options.controls) {
            jQuery("#sticky-container").html('<button id="save_note">Salvar</button><br/><button id="cancel_note" style="top:30px">Cancelar</button>');
        ...
        jQuery("#sticky-container,#Canvas,#content").click(function() {
...
jQuery.fn.stickyNotes.stopEditing = function(note_id) {
    ...
    jQuery("#p-note-" + note_id).click(function() {
...
jQuery.fn.stickyNotes.removeAllNotes = function() {
    jQuery(".sticky-container").html("");
...
jQuery.fn.stickyNotes.createNoteBackground = function() {
    ...
    if (jQuery.browser.msie && jQuery.browser.version <= 6)  {
        background = jQuery(document.createElement('div')).addClass("background").html('<img src="'+base+'flip/jornal/skins/king/img/spacer.gif" class="stretch" style="margin-top:5px;filter:progid:DXImageTransform.Microsoft.AlphaImageLoader(src=\''+base+'/flip/jornal/skins/king/img/sticky-bg.png\',sizingMethod=\'scale\'");" alt="" />');
    } else {
        background = jQuery(document.createElement('div')).addClass("background").html('<img src="'+base+'flip/jornal/skins/king/img/sticky-bg.png" class="stretch" style="margin-top:5px;" alt="" />');
    }
    return background;
