...
jQuery.jcalendar = function() {
    ...
    var _drawCalendar = function(dateIn, a, dayObject, monthObject, yearObject) {
        var today = new Date();
        var d;
        ...
        if (dateIn == undefined) {
            ...
            yearObject.val(today.getFullYear());
            monthObject.val(today.getMonth()+1);
            dayObject.val(today.getDate());
        }
        else {
        ...
        yearObject.val(d.getFullYear());
        monthObject.val(d.getMonth()+1);
        ...
        do {
            ...
            for (var i=0; i<7; i++) {
                ...
                if (curDay < 0 || curDay >= lastDay) {
                    ...
                    var id=existeEdicao(d);
                    var html='';
                    if(id == null){
                        html='<a href="javascript:void(0);" rel="'+ d +'" ><span class="linkinativo">'+ (curDay+1) +'</span></a>';
                    }else{
                        html='<a href="'+base+linkedicao+'?numero='+id+'" rel="'+ d +'"><span class="linkativo">'+ (curDay+1) +'</span></a>';
                    }
                    ...
                    dayStr = jQuery(html).click(function(e) {
                        if($(this,"span").hasClass("linkativo")){
                            if (_selectedDate) {
                                _selectedDate.removeClass('selected');
                                _selectedDate.removeClass('linkinativo');
                                _selectedDate.removeClass('linkativo');                            
                            }
                    ...
                    //if(_selectedDate == null || _selectedDate == undefined){
                    if (dIndex == d.getDate() && mIndex == (d.getMonth()+1) && yIndex == d.getFullYear()) {                        
        ...
        jQuery('div.jcalendar').html('<table cellspacing="2" border="0"></table><div class="jcalendar-links"></div>');
...
jQuery.fn.jcalendar = function(a) {
    this.each(function() {
        ...
        jQuery('.selecionado').append('<div class="jcalendar jcalendarintern"></div>');
