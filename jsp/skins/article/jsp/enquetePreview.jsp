...
<div class="enquete bg-geral">
    <div id="container" class="left">
        ...
        <div class="valign"><i class="fa fa-question" aria-hidden="true"></i></div>
    </div>                
    <div id="container" class="left">
        <div id="balance" class="valign"></div>
    ...
    <div id="container" class="right fechar">
        <div id="balance" class="valign"></div>
        <div  class="valign"><a href="javascript:void(0);" onclick="removerEnquete();"><i class="fa fa-times" aria-hidden="true"></i></a></div>
    </div>
</div>
<%}%>