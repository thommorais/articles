...
<c:if test="${page.flipModeloPublicacaoidid_modelo.prefs.exibeIndice}">
    <div id="indice" class="modal modal-texto" title="�ndice">
        <div class="modal-bg"></div>
...
<c:if test="${page.flipModeloPublicacaoidid_modelo.prefs.exibeSumario}">
    <div id="paginas" class="modal modal-texto" title="Sum�rio">
        <div class="modal-bg"></div>
            ...
            <div class="icones-esquerda">
                <ul>
                    ...
                    <c:if test="${!empty page.articles}">
                        <li><a title="Artigos desta edi��o"  id="btn-artigos" href="javascript:void(0);" onClick="abrirArtigos()"><i aria-hidden="true" class="fa fa-newspaper-o"></i></a></li>
                    </c:if>
    ...
    <section id="content">
        ...
        <article id="interna">
            ...
            <div id="searchinstant" style="display:none">
                Pesquisa instant�nea habilitada! Para procurar por v�rias palavras separe-as com v�rgula.
            ...
            <div id="reader" class="magazine-viewport stage">
                ...
                <div id="readerarrows">
                    ...
                    <div class="arrow-navigate arrow-navigate-right next-button" title="Pr�xima p�gina">
