...
Ext.Carousel = Ext.extend(Ext.Panel, {
    ...
    onDragEnd : function(e, t) {
        ...
        if (deltaOffset < 0 && Math.abs(deltaOffset) > 200 && previousDelta <= 0 && this.layout.getNext()) {
            this.next();
        }
        
        else if (deltaOffset > 0 && Math.abs(deltaOffset) > 200 && previousDelta >= 0 && this.layout.getPrev()) {
            this.prev();
        }
        else {
